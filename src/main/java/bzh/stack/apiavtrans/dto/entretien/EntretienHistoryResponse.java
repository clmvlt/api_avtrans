...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Réponse paginée pour l'historique des entretiens")
public class EntretienHistoryResponse {

    @Schema(description = "Indique si l'opération a réussi", example = "true")
    private Boolean success;

    @Schema(description = "Liste des entretiens de la page courante")
    private List<EntretienDTO> content;
