...
public class VehiculeFileDTO {

    @Schema(description = "Unique file identifier", example = "123e4567-e89b-12d3-a456-426614174000")
    private UUID id;

    @Schema(description = "Vehicle identifier", example = "123e4567-e89b-12d3-a456-426614174001")
    private UUID vehiculeId;

    @Schema(description = "Base64 encoded file content")
    private String fileB64;

    @Schema(description = "Original file name", example = "carte_grise.pdf")
    ...
    @Schema(description = "File download URL", example = "http://192.168.1.120:8081/uploads/vehicule-files/file.pdf")
